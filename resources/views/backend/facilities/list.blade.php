...
<div class="page-header row no-gutters py-4">
  ...
  <a href="{{ route('facilities.create')}}" class="btn btn-primary mt-4 ml-2"><i class="fa fa-plus"></i> Add Facilities</a>
  </div>
</div>
<!-- End Page Header -->
<!-- Default Light Table -->
          ...
          <table id="event-table" class="table table-striped table-bordered" style="width:100%">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                <img style="width:100px; height:100px; object-fit:cover;" src="{{ url("images/$l->featured_image")}}" alt="">
                </td>
                {{-- <td>
                    @if ($l->status==0)
                ...
                <form class="d-inline" action="{{ route('facilities.edit',$l->id)}}" method="GET">
                    <button type="submit" class="btn btn-sm btn-primary">Edit</button>
                </form>
                {!! Form::open(['route' => ['facilities.destroy',$l->id],'method'=>'DELETE','class'=>'d-inline']) !!}
