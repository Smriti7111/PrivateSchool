...
<div class="row">
	<div class="col-lg-9 col-md-12">
		...
		<div class="card card-small mb-3">
			<div class="card-body">
                @if(isset($edit))
                    {!! Form::open(['route' => ['photos.update',$edit->photo_id],'method'=>'PUT','id'=>'update','files'=>true]) !!}
                    {!! Form::label('album_id','Album Id:') !!}
                    {!! Form::text('album_id',$edit->album_id,array('class' => 'form-control','required'=>'')) !!}
                    ...
                    {!! Form::close() !!}
                @else
                    {!! Form::open(['route' => ['photos.store'],'method'=>'POST','id'=>'store','files' => true]) !!}
                    {!! Form::label('album_id','Album Id:') !!}
                    {!! Form::select('album_name[]',$albums,'Kosovo',['class'=>'form-control','placeholder'=>'Select Album']) !!}
                    {!! Form::label('name','Name:') !!}
