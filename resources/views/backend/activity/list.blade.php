...
<div class="page-header row no-gutters py-4">
  ...
  <a href="{{ route('activity.create')}}" class="btn btn-primary mt-4 ml-2"><i class="fa fa-plus"></i> Add New Activity</a>
  </div>
</div>
<!-- End Page Header -->
<!-- Default Light Table -->
       ...
       <div class="table-responsive p-1">
          <table id="event-table" class="table table-striped table-bordered" style="width:100%">
            <thead>
              <tr>
                <th>Date</th>
                <th>Activitylbum Name</th>
                <th>Activity Description</th>
                <th>Featured Activity Img</th>
                <th>Actions</th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr>
                ...
                {!! Form::open(['route' => ['activity.edit',$l->id],'method'=>'GET','class'=>'d-inline']) !!}
                {!! Form::submit('Edit', array('class' => 'btn btn-sm btn-primary' )) !!}
                    {!! Form::close() !!}
                {!! Form::open(['route' => ['activity.destroy',$l->id],'method'=>'DELETE','class'=>'d-inline']) !!}
